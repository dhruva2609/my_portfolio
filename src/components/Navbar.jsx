  ...
  return (
    <nav className="bg-primary-50/80 dark:bg-primary-900/80 backdrop-blur-md border-b border-primary-200 dark:border-primary-700 shadow-sm w-full z-50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between py-3 px-4">
        <Link
          className="font-bold text-3xl uppercase tracking-widest text-primary-500 dark:text-primary-200"
          to="/"
        >
          MyPortfolio
        </Link>
        ...
        >
          <ul className="flex flex-col md:flex-row md:space-x-6 mt-4 md:mt-0 items-center">
                  ...
                  className={`block px-3 py-2 rounded-lg font-semibold text-lg tracking-wide transition
                    ${
                      location.pathname === item.to
                        ? "text-blue-600 bg-blue-100 dark:text-primary-200 font-bold bg-primary-100 dark:bg-primary-800"
                        : "text-neutral-800 dark:text-primary-200 hover:text-blue-600 dark:hover:text-primary-300"
                    }`}
                  to={item.to}
            ...
            <li className="mt-3 md:mt-0 md:ml-4">
              <button
                className="border border-primary-500 dark:border-primary-400 text-primary-500 dark:text-primary-200 hover:bg-primary-500 hover:text-white dark:hover:bg-primary-600 font-semibold px-4 py-2 rounded-lg transition"
