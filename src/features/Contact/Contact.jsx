...
const Contact = () => {
  ...
  return (
    <section id="contact" className="container mx-auto py-10 px-4 max-w-xl">
      <h2
        className={`mb-6 text-3xl font-bold text-blue-700 dark:text-primary-100 text-center transition-all duration-1000 ${fadeClass}`}
      >
        Contact
      </h2>
      <form
      ...
      >
        ...
        <button
          type="submit"
          className="w-full bg-blue-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 text-white dark:text-primary-900 font-semibold py-2 px-6 rounded-lg transition disabled:opacity-60"
          disabled={loading}
        >
